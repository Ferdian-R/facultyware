...
CREATE TABLE IF NOT EXISTS `facultyware`.`survey_question_assignments` (
  ...
  CONSTRAINT `survey_question_assignments_survey_id_foreign`
    FOREIGN KEY (`survey_id`) REFERENCES `facultyware`.`surveys` (`id`) ON DELETE CASCADE,
  CONSTRAINT `survey_question_assignments_survey_question_id_foreign`
    FOREIGN KEY (`survey_question_id`) REFERENCES `facultyware`.`survey_questions` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `facultyware`.`survey_responses` (
  ...
  CONSTRAINT `survey_responses_survey_invitation_id_foreign`
    FOREIGN KEY (`survey_invitation_id`) REFERENCES `facultyware`.`survey_invitations` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `facultyware`.`survey_answers` (
  ...
  CONSTRAINT `survey_answers_survey_response_id_foreign`
    FOREIGN KEY (`survey_response_id`) REFERENCES `facultyware`.`survey_responses` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `facultyware`.`survey_answer_options` (
  ...
  CONSTRAINT `survey_answer_options_survey_answer_id_foreign`
    FOREIGN KEY (`survey_answer_id`) REFERENCES `facultyware`.`survey_answers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `survey_answer_options_survey_question_option_id_foreign`
    FOREIGN KEY (`survey_question_option_id`) REFERENCES `facultyware`.`survey_question_options` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `facultyware`.`audit_logs` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `partner_id` BIGINT UNSIGNED,
  `action` VARCHAR(255),
  PRIMARY KEY (`id`),
  CONSTRAINT `audit_logs_ibfk_1` FOREIGN KEY (`partner_id`) REFERENCES `facultyware`.`partners` (`id`) ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
